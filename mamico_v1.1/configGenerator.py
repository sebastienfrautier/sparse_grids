...
if __name__ == '__main__':
    ...
    problem.addVariables(["DOMAIN_SIZE_X", "DOMAIN_SIZE_Y"], np.arange(40,45,1))
    problem.addVariables(['LINKED_CELL_SIZE_Y', 'LINKED_CELL_SIZE_X'], range(1,40,5))
    problem.addVariables(["BLOCK_SIZE"], list([1,10,100,1000])) #logarithmic steps
    ...
    n=2000
    name ="full_config_lists_full.1111"
